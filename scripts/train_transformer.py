"""
Train transformer models for all languages.
"""
import sys
...
def main():
    ...
    print("2. roberta-base (English, better accuracy)")
    ...
    for lang in LANGUAGES:
        ...
        try:
            ...
            train_transformer(
                ...
                model_type=model_type if lang == "en" or model_type in multilingual_models else "xlm-roberta-base",
                use_tuning=True,
                max_length=128,
                batch_size=16,
                learning_rate=2e-5,
    ...
    print("2. Compare transformer results with other models")
